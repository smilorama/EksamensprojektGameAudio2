...
public partial class AkUnitySoundEngine {
  ...
  /// <param name="in_bankType"> Type of the bank to load</param>
  public static AKRESULT LoadBank(uint in_bankID, uint in_bankType) { return (AKRESULT)AkUnitySoundEnginePINVOKE.CSharp_LoadBank__SWIG_3(in_bankID, in_bankType); }
  ...
  ///  - AK.SoundEngine.UnloadBank"/>
  /// <param name="in_bankID"> Bank ID of the bank to load</param>
  public static AKRESULT LoadBank(uint in_bankID) { return (AKRESULT)AkUnitySoundEnginePINVOKE.CSharp_LoadBank__SWIG_4(in_bankID); }
  ...
  public static AKRESULT LoadBank(string in_pszString, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie, out uint out_bankID, uint in_bankType) {
    ...
    { return (AKRESULT)AkUnitySoundEnginePINVOKE.CSharp_LoadBank__SWIG_5(in_pszString, global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero, out out_bankID, in_bankType); }
  }
  ...
  public static AKRESULT LoadBank(string in_pszString, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie, out uint out_bankID) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
    { return (AKRESULT)AkUnitySoundEnginePINVOKE.CSharp_LoadBank__SWIG_6(in_pszString, global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero, out out_bankID); }
  }
  ...
  public static AKRESULT LoadBank(uint in_bankID, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie, uint in_bankType) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
    { return (AKRESULT)AkUnitySoundEnginePINVOKE.CSharp_LoadBank__SWIG_9(in_bankID, global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero, in_bankType); }
  }
  ...
  public static AKRESULT LoadBank(uint in_bankID, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
    { return (AKRESULT)AkUnitySoundEnginePINVOKE.CSharp_LoadBank__SWIG_10(in_bankID, global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero); }
  }
  ...
  /// <returns>The device ID as returned by IMMDevice->GetId, hashed by AK::SoundEngine::GetIDFromName()</returns>
  public static uint GetDeviceIDFromName(string in_szToken) { return AkUnitySoundEnginePINVOKE.CSharp_GetDeviceIDFromName(in_szToken); }
  ...
  /// <returns>The name of the device at the "index" specified.  The pointer is valid until the next call to GetWindowsDeviceName.</returns> 
  /// <param name="index"> Index of the device in the array.  -1 to get information on the default device.</param> 
  /// <param name="out_uDeviceID"> Device ID for Wwise.  This is the same as what is returned from AK::GetDeviceID and AK::GetDeviceIDFromName.  Use it to specify the main device in AkPlatformInitSettings.idAudioDevice.</param> 
  /// <param name="uDeviceStateMask"> Optional bitmask used to filter the device based on their state.</param>
  public static string GetWindowsDeviceName(int index, out uint out_uDeviceID, AkAudioDeviceState uDeviceStateMask) { return AkUnitySoundEngine.StringFromIntPtrWString(AkUnitySoundEnginePINVOKE.CSharp_GetWindowsDeviceName__SWIG_0(index, out out_uDeviceID, (int)uDeviceStateMask)); }
  ...
  /// <param name="index"> Index of the device in the array.  -1 to get information on the default device.</param> 
  /// <param name="out_uDeviceID"> Device ID for Wwise.  This is the same as what is returned from AK::GetDeviceID and AK::GetDeviceIDFromName.  Use it to specify the main device in AkPlatformInitSettings.idAudioDevice.</param>
  public static string GetWindowsDeviceName(int index, out uint out_uDeviceID) { return AkUnitySoundEngine.StringFromIntPtrWString(AkUnitySoundEnginePINVOKE.CSharp_GetWindowsDeviceName__SWIG_1(index, out out_uDeviceID)); }

  ///  Get the number of Audio Endpoints available for the specified device state mask.
  /// <returns>The number of Audio Endpoints available for the specified device state mask.</returns> 
  /// <param name="uDeviceStateMask"> Optional bitmask used to filter the device based on their state.</param>
  public static uint GetWindowsDeviceCount(AkAudioDeviceState uDeviceStateMask) { return AkUnitySoundEnginePINVOKE.CSharp_GetWindowsDeviceCount__SWIG_0((int)uDeviceStateMask); }

  ///  Get the number of Audio Endpoints available for the specified device state mask.
  /// <returns>The number of Audio Endpoints available for the specified device state mask.</returns>
  public static uint GetWindowsDeviceCount() { return AkUnitySoundEnginePINVOKE.CSharp_GetWindowsDeviceCount__SWIG_1(); }
  ...
  public const int NTDDI_VERSION = 0x06020000;
